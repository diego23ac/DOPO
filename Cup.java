...
public class Cup {
    ...
    private void createCup(int tMaxHeight,int tWidth, int tHeight) {
        ...
        if (this.height > 1) {
            Rectangle base = new Rectangle(20,this.height*20,color,30+mid,280-tHeight*20);
            base.makeVisible();
            cupRectangle[0] = base;
            Rectangle ladoA = new Rectangle(this.height*20,20,color,30+mid,300-this.height*20-tHeight*20);
            ladoA.makeVisible();
            cupRectangle[1] = ladoA;
            Rectangle ladoB = new Rectangle(this.height*20,20,color,mid+10+this.height*20,300-this.height*20-tHeight*20);
            ladoB.makeVisible();
